    ...
    init {
        ...
        val securityRoom = Room(
            ...
            "The security team's last stand is painted across the walls in broad strokes of crimson. " +
                    "Smashed rifles and dented armor tell the story—they fought hard. They lost harder. The predator " +
                    "didn't just kill them; it arranged the corpses, like some grotesque trophy display. The " +
                    "emergency lockdown button lies just out of reach... beneath a slowly spreading pool of blood."
        )

        val ammunitionDepotRoom = Room(
            "Ammunition Depot",
            "The armory is a tomb of wasted firepower—shattered racks of rifles line the walls, their " +
                    "barrels bent into unnatural shapes. Crates of grenades sit unopened, their seals intact... and " +
                    "covered in a web of sticky, translucent fibers. The scent of gunpowder mixes with something muskier, " +
                    "something alive. A single undamaged shotgun rests on the counter—its ejection port clogged with a " +
                    "throbbing, vein-like growth. The alien didn’t just raid this place. It claimed it." +
                    ""
        )

        val startRoom = Room(
            "LAST BREATH",
            "Last Breath is a game is about escaping your spaceship after a predatory alien has boarded " +
                    "your space craft and has killed every person who once called this ship home. Your mission is to navigate " +
                    "through the now destroyed ship with your minimal oxygen depleting with every step and an unfinished map. " +
                    "But be cautious because if you run out of oxygen before you get to the escape pods, the alien will achieve its final kill.  "
        )
        ...
        val weaponsRoom = Room(
            ...
            "Cold dread seeps in as you stare at the empty racks—not just cleared, but peeled open with terrifying precision. " +
                    "The reinforced steel is curled back like flower petals, the few remaining sidearms crushed into useless scrap. " +
                    "A single survival knife juts from the wall, embedded to the hilt in a dark, coagulated stain. Whatever did this " +
                    "knew exactly how to disarm you."
        )

        val labRoom = Room(
            "Lab Room",
            "The containment pods lie shattered—not from the inside, but from something breaking in. Thick, " +
                    "viscous fluid drips from empty embryo tanks, their stolen contents evident by the drag marks leading toward the " +
                    "vents. A fractured security feed shows a single frame: curled, leathery husks being hauled away into darkness."
        )

        val comsRoom = Room(
            "Communications",
            "Your hope fades as you enter. The alien clawed through every console, wires ripped out like tendons. " +
                    "Shattered screens dangle by their cables, swinging gently—as if something just left. The emergency beacon " +
                    "lies in pieces, its transmitter crushed underfoot. No signals are getting out."
        )

        val gymRoom = Room(
            "Gym Room",
            "The gym’s lights flicker to life as you enter, revealing a space frozen mid-workout. Treadmills " +
                    "still run at full speed, their belts stained with dark fluids. A workout playlist crackles through " +
                    "broken speakers—just upbeat enough to make the claw marks on the lockers feel surreal. The only thing out" +
                    " of place? Every single mirror is angled just wrong. You never get a full reflection. Just glimpses " +
                    "of something moving when you turn your head."
        )
        ...
        val gardenRoom = Room(
            "Gardens",
            "The ship’s garden is a ravaged wasteland—smashed grow-pods, half-eaten plants, and gnawed " +
                    "ration packs litter the floor. Claw marks tear through the soil where the alien dug up every " +
                    "edible root and berry. A crewmate’s boot lies in the corner, filled with squirming tendrils. " +
                    "It didn’t just kill here… it feasted."
        )

        val alienRoom = Room(
            "Alien Entry Point",
            "The ship’s hull is split like a wound stitched shut—jagged metal fused in unnatural patterns, " +
                    "Nearby, a maintenance drone lies crushed against the wall. soldiers body's lay motionless, a " +
                    "futile human attempt to patch what the alien had already closed behind it. Not to keep " +
                    "the void out… but to keep you in."
        )

        val meetingRoom = Room(
            "Meeting Room",
            "The holographic projector still hums, casting a ghostly agenda list onto the smoke-stained table. " +
                    "'Emergency Protocols' sits unchecked at the bottom. Chairs are overturned—not in panic, but in some unnatural " +
                    "pattern, like a grotesque mockery of a discussion circle. At the head of the table, a coffee cup sits " +
                    "untouched, its surface rippling faintly. Not from steam. From the thing that's breathing into it."
        )

        val oRoom = Room(
            "Oxygen Room",
            "The backup O2 generators sputter to life as you enter, their weak but steady hum a temporary " +
                    "reprieve from the ship's death rattle. The main systems are still fried, vents clogged with strands " +
                    "of something dark and fibrous that pulses when you're not looking. A flickering screen reports your " +
                    "oxygen reserves increasing - just enough to matter, not enough to survive. Across the room, a shattered " +
                    "visor lies in a pool of frozen breath, a reminder that not everyone got this second chance. Though " +
                    "this was only a one time opportunity."
        )
        ...
        val engineRoom = Room(
            ...
            "The deafening hum of the reactors has been replaced by an eerie silence, broken only by the occasional " +
                    ...
                    "The emergency lights cast long shadows from the mangled machinery—something didn’t just disable the engines… " +
                    "it savaged them."
        )

        val cafeRoom = Room(
            "Cafeteria",
            "The stench of rotting food and copper hangs thick. A chair lies toppled, tray upended—someone abandoned their " +
                    "last meal in terror. Behind the kitchen’s broken door, something shifts in the darkness. Metal creaks. A wet, " +
                    "rhythmic sound follows. Whatever’s in there… it’s feeding."
        )
